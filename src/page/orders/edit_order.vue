<template>
    <div class="DN editOrder" v-loading="loading">
        ...
        <div class="baseform" v-show="baseActive">
            ...
            <div class="el-row">
                <div class="el-col el-col-12">
                    ...
                    <el-input placeholder="请输入内容" class="inline-input" size="small" v-model.trim="orderInfo.contacts"></el-input>
                </div>
                <div class="el-col el-col-12">
                    <div class="base_hd"><em>*</em>联系电话：</div>
                    <el-input placeholder="请输入内容" class="inline-input" size="small" v-model.trim="orderInfo.contacts_phone"></el-input>
                </div>
            </div>
            <div class="el-row">
                <div class="el-col el-col-12">
                ...
                <div class="el-col el-col-12">
                    ...
                    <el-input placeholder="请填写进场里程" class="inline-input" size="small" v-model.trim="orderInfo.advance_mileage"></el-input>
                </div>
                <div class="el-col el-col-12" style="margin-top:20px;">
                    <div class="base_hd">下次保养里程：</div>
                    <el-input placeholder="请填写下次保养里程" class="inline-input" size="small" v-model.trim="orderInfo.the_next_maintenance_mileage"></el-input>
                </div>
            </div>
            <div class="el-row">
                <div class="el-col el-col-12">
                    ...
                    <el-input
                        ...
                        resize="none"
                        maxlength="200"
                        v-model.trim="orderInfo.customer_statement"
                ...
                <div class="el-col el-col-12">
                    ...
                    <el-input
                        ...
                        maxlength="200"
                        placeholder="最多200字"
                        v-model.trim="orderInfo.service_advisor_notes"
        ...
        <div class="baseform" v-show="baseActive == false">
            <div class="el-row" style="border-top:none;">
                <div class="el-col el-col-12">
                    ...
                    <el-input
                        ...
                        resize="none"
                        maxlength="200"
                        v-model.trim="orderInfo.detection_result"
                ...
                <div class="el-col el-col-12">
                    ...
                    <el-input
                        ...
                        maxlength="200"
                        placeholder="最多200字"
                        v-model.trim="orderInfo.follow_up_maintenance_proposal"
                            ...
                            <div class="el-col el-col-5">
                                <el-form label-width="50px">
                                    <el-form-item label="价格" size="small">
                                        <el-input v-model.trim="item.price" @input="handleProCount">
            ...
            <div class="el-row">
                    ...
                    <ul class="optgroup" style="width: 75%;float:left;box-sizing: border-box;padding-left: 5px;">
                        <li style="padding:18px 0 0 20px" v-for="(item,index) in orderInfo.required_accessories_ids" :key="index">
                            ...
                            <div class="el-col el-col-5">
                                <el-form label-width="50px">
                                    <el-form-item label="价格" size="small">
                                        <el-input v-model.trim="item.price" @input = 'handlePartsCount'>
                                            <template slot="prepend">￥</template>
                                        </el-input>
                                    </el-form-item>
                                </el-form>
                            ...
                            <div class="el-col el-col-6" style="text-align: center">
                                数量：<el-input-number label="数量" size="small" v-model.trim="item.quantity" @change="handlePartsCount" :min="1"></el-input-number>
                            </div>
                            <div class="el-col el-col-3">
                ...
                <el-col class="el-col-24" style="margin-top:10px;">
                    ...
                    <span style="color:#e01823">¥ {{orderInfo.total_amount_payable.toFixed(2)}}</span>
                </el-col>
                <div class="el-col el-col-12" style="margin-top:20px;">&nbsp;</div>
                <div class="el-col el-col-24">
                    <div class="base_hd" style="width: 10%; float: left;">&nbsp;</div>
        ...
        <!--出库信息弹窗-->
        <el-dialog title="配件出库" :visible.sync="dialogTableVisible">
        ...
        methods: {
            ...
            async submitEdit(){
                ...
                if(res.state_code == 'ok'){
                    ...
                    this.$router.push('/manage/orders/working')
                }else{
                    this.$message({
                        type:'error',
                        message:res.err_message
            ...
            async genOutConfirm(){
                ...
                if(data.state_code == 'ok'){
                    ...
                    const res = await confirmOut({order_id:this.orderInfo.id,employee_id:1})
                    this.loading = false;
                    if(res.state_code == 'ok'){
